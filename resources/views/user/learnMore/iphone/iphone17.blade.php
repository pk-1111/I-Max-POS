...
@section('content')
  ...
  <section class="max-w-7xl mx-auto px-4 py-20 text-center">
    ...
    <div class="flex justify-center">
      <img src="{{ asset('user/image/iPhone17Details.jpg') }}" alt="Magicchromatic iPhones" class="w-full max-w-4xl rounded-2xl shadow-xl">
    </div>
  </section>
  ...
  <section class="max-w-7xl mx-auto px-4 py-20">
    ...
    <div class="flex justify-center mb-8">
      <img src="{{ asset('user/image/iPhone17Screen.jpg') }}" alt="iPhone 17 All-Screen Design" class="w-full max-w-5xl rounded-2xl shadow-xl">
    </div>
    <div class="flex justify-center space-x-3 mb-16">
      <span class="w-4 h-4 rounded-full bg-pink-500 cursor-pointer border-2 border-transparent hover:border-blue-500"></span>
      <span class="w-4 h-4 rounded-full bg-green-400 cursor-pointer border-2 border-transparent hover:border-blue-500"></span>
      <span class="w-4 h-4 rounded-full bg-blue-400 cursor-pointer border-2 border-transparent hover:border-blue-500"></span>
      <span class="w-4 h-4 rounded-full bg-purple-400 cursor-pointer border-2 border-transparent hover:border-blue-500"></span>
      <span class="w-4 h-4 rounded-full bg-orange-400 cursor-pointer border-2 border-transparent hover:border-blue-500"></span>
      <span class="w-4 h-4 rounded-full bg-red-400 cursor-pointer border-2 border-transparent hover:border-blue-500"></span>
    </div>
  </section>
