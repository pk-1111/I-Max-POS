...
@section('content')
    <main class="bg-black text-white font-sans">
        ...
        <section class="py-20 text-center">
            ...
            <h1
                class="text-6xl md:text-8xl font-bold tracking-tighter mb-10 text-transparent bg-clip-text bg-gradient-to-b from-orange-300 to-orange-600">
                PRO
            </h1>
        ...
        <section class="max-w-7xl mx-auto px-4 py-10">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="bg-zinc-900 rounded-3xl p-8 overflow-hidden flex flex-col items-center text-center">
                    ...
                    <img src="{{ asset('user/image/iPhone17ProBody.jpg') }}" alt="Design"
                        class="mt-auto h-64 object-contain">
                </div>

                <div class="bg-zinc-900 rounded-3xl p-8 overflow-hidden flex flex-col items-center text-center">
                    <h3 class="text-xl font-semibold mb-4 text-zinc-300">Hard-forged aluminium unibody.</h3>
                    <img src="{{ asset('user/image/iPhone17ProBody.jpg') }}" alt="Material"
                        class="mt-auto h-64 object-contain">
                </div>
                ...
                <div class="bg-zinc-900 rounded-3xl p-8 md:col-span-2 flex flex-col md:flex-row items-center gap-8">
                    <div class="md:w-1/2">
                        ...
                        <h3 class="text-3xl font-bold mb-4 leading-tight">48MP Telephoto camera. With 5x optical-quality
                            zoom.</h3>
                    </div>
